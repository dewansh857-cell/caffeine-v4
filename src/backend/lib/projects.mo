...
module {
  ...
  public func sampleProjects(now : Common.Timestamp) : [ProjectTypes.Project] {
    ...
    let mkVer = func(_name : Text) : [ProjectTypes.ProjectVersion] {
    ...
    [
      ...
      },
      {
        ...
        answers = "{}";
        specSections = [];
        metadata = mkMeta(#building, #medium, ["community", "social"]);
      ...
      },
      {
        ...
        answers = "{}";
        specSections = [];
        metadata = mkMeta(#defining, #high, ["content", "records"]);
      ...
      },
      {
        ...
        answers = "{}";
        specSections = [];
        metadata = mkMeta(#exploring, #medium, ["fitness", "tracking"]);
      ...
      },
      {
        ...
        answers = "{}";
        specSections = [];
        metadata = mkMeta(#idea, #low, ["content", "media"]);
