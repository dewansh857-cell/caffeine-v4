  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'status-live-bg': 'var(--color-status-live-bg)',
        'status-building': 'var(--color-status-building)',
        'status-building-bg': 'var(--color-status-building-bg)',
        'status-exploring': 'var(--color-status-exploring)',
        'status-exploring-bg': 'var(--color-status-exploring-bg)',
        'status-defining': 'var(--color-status-defining)',
        'status-defining-bg': 'var(--color-status-defining-bg)',
        'status-idea': 'var(--color-status-idea)',
        'status-idea-bg': 'var(--color-status-idea-bg)',
        ...
        "mode-accent-muted": "var(--color-accent-muted)",
      ...
      boxShadow: {
        ...
        "card-hover": "0 12px 32px oklch(0 0 0 / 0.12), 0 4px 12px oklch(0 0 0 / 0.08)",
        "cta-strong": "0 4px 16px oklch(0 0 0 / 0.15)",
        "card-distinct": "0 2px 12px oklch(0 0 0 / 0.08), 0 1px 4px oklch(0 0 0 / 0.04)",
        "detail-panel": "0 4px 20px oklch(0 0 0 / 0.1), 0 1px 6px oklch(0 0 0 / 0.06)",
        "tab-divider": "inset 0 -2px 0 0 var(--tab-border-color)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
